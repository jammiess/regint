import pytest
from fsm import FSM, null, epsilon, unspecified

if __name__ == "__main__":
    raise Exception("Test files can't be run directly."
...
def test_addbug():
    ...
    int5A = FSM(
        ...
        accepting={1},
        transition={
            0: {unspecified: 0, "a": 0, "b": 0, "c": 0},
            1: {unspecified: 0, "a": 0, "b": 1, "c": 1},
        }
    )
    ...
    int5B = FSM(
        ...
        accepting={0},
        transition={
            0: {unspecified: 2, "a": 2, "b": 2, "c": 2},
            1: {unspecified: 2, "a": 2, "b": 2, "c": 0},
            2: {unspecified: 2, "a": 2, "b": 2, "c": 2},
        }
    )
...
def test_repr():
    ...
    assert str(unspecified) == "unspecified"
